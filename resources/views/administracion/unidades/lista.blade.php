                ...
                <div class="card-body">
                    ...
                    <div class="portlet box blue">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-info-circle"></i>Lista de Unidades
                            </div>
                            <div class="actions">
                                <div class="btn-group btn-group-devided" data-toggle="buttons">
                                  <a href="#basic" class="btn green" data-toggle="modal">Nueva unidad
                                  ...
                                  <?php $c = 1; ?>
                                    @foreach ($datos as $uni)
                                        <tr>
                                            ...
                                            <td class="text-center"><?php echo $uni->unidad; ?></td>
                                            <td class="text-center">


                                              <form form method="post" action="{{ url('unidades/' . $uni->id . '/eliminar') }}">
                                                {{ csrf_field() }}
                                                <a href="{{ url('unidades/' . $uni->id . '/editar') }}" rel="tooltip" title="Editar Cargo" class="btn btn-success btn-simple btn-fab btn-fab-mini">
...
<div class="modal fade in" id="basic" tabindex="-1" role="basic" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form method="post" action="crearUnidad" class="form-horizontal">
                {{ csrf_field() }}
