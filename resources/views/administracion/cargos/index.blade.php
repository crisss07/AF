                        ...
                        <div class="portlet-title">
                            ...
                            <div class="actions">
                                <div class="btn-group btn-group-devided" data-toggle="buttons">
                                    <a href="#crear" class="btn green" data-toggle="modal">Nuevo Cargo
                                    ...
                                    @foreach ($cargos as $key => $cargo)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <form form method="post" action="{{ url('cargo/' . $cargo->id . '/eliminar') }}">
                                                {{ csrf_field() }}
                                                <a href="{{ url('cargo/' . $cargo->id . '/editar') }}" rel="tooltip" title="Editar Cargo" class="btn btn-success btn-simple btn-fab btn-fab-mini">
...
<div class="modal fade in" id="crear" tabindex="-1" role="crear" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form method="post" action="{{ url('cargo/guardar') }}" class="form-horizontal">
                {{ csrf_field() }}
